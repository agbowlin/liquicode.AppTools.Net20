...
[TestFixture]
public class TestMatrixDimensionY : TestMatrixDimension
{
	...
	{
		Test_Swap_Forward( this._matrix.Y );
	}
	...
	{
		Test_Swap_Backward( this._matrix.Y );
	}
	...
	{
		Test_Copy_Forward( this._matrix.Y );
	}
	...
	{
		Test_Copy_Backward( this._matrix.Y );
	}
	...
	{
		Test_Move_Forward( this._matrix.Y );
	}
	...
	{
		Test_Move_Backward( this._matrix.Y );
	}
	...
	{
		Test_AppendDelete( this._matrix.Y );
	}
	...
	{
		Test_InsertDelete( this._matrix.Y );
	}
	...
	{
		Test_InsertMoveDelete( this._matrix.Y );
	}
